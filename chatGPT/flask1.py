...
import random
from smtpmail import sendmaill
#import sql1
...
def login():
    if request.method == 'POST':
        try:
            ...
            return render_template('login.html', sqlerror="SQLite error occured. Please try again!")
    ...
    if 'username' in session:
        ...
        if request.method == 'POST':
            if request.form['submit_button'] == 'Reboot':
                ...
                pass
            elif request.form['submit_button'] == 'Send Dogecoin':
...
def register():
    if request.method == 'POST':
        try:
            ...
            return render_template('register.html', sqlerror="SQLite error occured. Please try again!")
